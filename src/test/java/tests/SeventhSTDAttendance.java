...
public class SeventhSTDAttendance extends CommonMethod{

	public SeventhSTDAttendance() throws Exception {
		super();
	...
	@Test
	public void SeventhStdAttendance() throws Exception {
