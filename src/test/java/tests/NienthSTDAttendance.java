...
public class NienthSTDAttendance extends CommonMethod {

	public NienthSTDAttendance() throws Exception {
		super();
	...
	@Test
	public void NienthSTD() throws Exception {
