...
public class LKGClassAttendance extends CommonMethod{

	public LKGClassAttendance() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}
	
	Logger log = LogManager.getLogger(LKGClassAttendance.class);
