...
public class EightSTDAttendance extends CommonMethod{

	public EightSTDAttendance() throws Exception {
		super();
	...
	@Test
	public void EightStdAttendance() throws Exception {
