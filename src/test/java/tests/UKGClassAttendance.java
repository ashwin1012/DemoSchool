...
public class  UKGClassAttendance extends CommonMethod{

	public UKGClassAttendance() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	Logger log = LogManager.getLogger(UKGClassAttendance.class);
