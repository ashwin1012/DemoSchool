...
public class FourthSTDAttendance extends CommonMethod {

	

	public FourthSTDAttendance() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	Logger log = LogManager.getLogger(FourthSTDAttendance.class);
